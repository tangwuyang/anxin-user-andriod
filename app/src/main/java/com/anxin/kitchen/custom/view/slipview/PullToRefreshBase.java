package com.anxin.kitchen.custom.view.slipview;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		mode = a.getInteger(R.styleable.PullToRefresh_ptrMode, MODE_PULL_DOWN_TO_REFRESH);//mode = 0x3;
...
//		String releaseLabel = context.getString(R.string.pull_to_refresh_release_label);
		...
		String pullLabel = "111111";
		String refreshingLabel = "222222";
		String releaseLabel = "333333";
		...
		if (null != headerLayout) {
			headerLayout.setTextColor(Color.TRANSPARENT);
		}
		if (null != footerLayout) {
			footerLayout.setTextColor(Color.TRANSPARENT);
		}
		a.recycle();
