    ...
    protected void onResume() {
        ...
        if (isLogin()) {
            ...
            if (null != recoverSt && (!recoverSt.equals("null")) && recoverSt.length() > 10) {
                mChosedMeals = mGson.fromJson(recoverSt, new TypeToken<LinkedHashMap<String, RecoverBean.Data>>() {
                }.getType());
            }

            if (null != cachMenuSt && (!cachMenuSt.equals("null")) && cachMenuSt.length() > 10) {
                carhMenuList = mGson.fromJson(cachMenuSt, new TypeToken<List<RecorverMenuBean.Data>>() {
                }.getType());
            }
...
//                myLog("----GET_CA_MENU_MEAL----" + responseBody);
    ...
    public PopupWindow showPopWindow(View parent, View view, Context context, final ImageView iv_all) {
        ...
        mBottom.getLocationOnScreen(loaction);
        ...
        mPop.showAtLocation(mBottom, Gravity.NO_GRAVITY, (loaction[0]) - popWidth / 2, loaction[1] - popHeight);
    ...
    private class ContentAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            String number = holder.numTv.getText().toString();
            if (!number.equals("0")) {
                holder.numTv.setVisibility(View.VISIBLE);
                holder.reduceTv.setVisibility(View.VISIBLE);
            } else {
                holder.numTv.setVisibility(View.GONE);
                holder.reduceTv.setVisibility(View.GONE);
            }
            ...
            holder.reduceTv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (nums > 0) {
                        finalHolder1.numTv.setVisibility(View.VISIBLE);
                        finalHolder1.reduceTv.setVisibility(View.VISIBLE);
                    } else {
                        finalHolder1.numTv.setVisibility(View.GONE);
                        finalHolder1.reduceTv.setVisibility(View.GONE);
                    }
                }
            });
